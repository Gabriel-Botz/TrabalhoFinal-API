...
public class AvaliacaoSerieService {
    ...
    @Transactional
    public AvaliacaoSerieResponseDTO inserir(org.serratec.TrabalhoFinal_API.dto.request.AvaliacaoSerieRequestDTO dto) {

        Usuario usuario = usuarioRepository.findById(dto.getUsuarioId())
                .orElseThrow(() -> new RecursoNaoEncontradoException("Usuairio não encontrado"));

        // Falta a classe Serie
    ...
    @Transactional
    public AvaliacaoSerieResponseDTO atualizar(UUID id,
            org.serratec.TrabalhoFinal_API.dto.request.AvaliacaoSerieRequestDTO dto) {
